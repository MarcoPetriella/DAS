...
#    ch_caxis_c = check_caxis_c.get()   
    ...
    ax_a.set_title('Banda A: ' + str(parametros[0]) + ' - ' + str(parametros[1]) + ' Hz' + ' - Banda B: ' + str(parametros[2]) + ' - ' + str(parametros[3]) + ' Hz' + ' - Banda C: ' + str(parametros[4]) + ' - ' + str(parametros[5]) + ' Hz')    
...
#    im_a.set_alpha(banda_b1/100.*0.7)     
#    im_b.set_alpha(banda_b2/100.*0.5)  
...
entrada_minL_a=Tk.Label(root,text="Caxis min: ")
...
entrada_maxL_a=Tk.Label(root,text="Caxis max: ")
entrada_maxL_a.grid(column=0,row=3)
text_a = max_var_a.get()
max_var_a.set(0.010)

check_caxis_a = Tk.IntVar()
caxis_box_a=Tk.Checkbutton(root,text="Caxis Min-Max",variable=check_caxis_a)
...
# Ax1
ax_a = fig.add_axes([.03,.1,.90,.72]) 
im_a = ax_a.imshow(data_a, cmap=plt.get_cmap('jet'),alpha=0.9,aspect='auto',interpolation='none')
fig.colorbar(im_a)    
#ax_a.set_title('Banda A: ' + str(banda_ai_s) + ' - ' + str(banda_af_s) + ' Hz')

#ax_b = fig.add_axes([.36,.1,.27,.72]) 
#im_b = ax_a.imshow(data_b, cmap=plt.get_cmap('jet'),alpha=0.5,aspect='auto',interpolation='none')
#fig.colorbar(im_b)
#ax_b.set_title('Banda B: ' + str(banda_bi_s) + ' - ' + str(banda_bf_s) + ' Hz')

#ax_c = fig.add_axes([.7,.1,.27,.72]) 
#im_c = ax_a.imshow(data_c, cmap=plt.get_cmap('jet'),alpha=0.5, aspect='auto',interpolation='none')
#fig.colorbar(im_c)
